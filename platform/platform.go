...
type Telegram interface {
	...
	SendProductInquiryNotification(telegramUserID int64, inquiry dto.ProductInquiry) error
	SendProductInquiryReviewNotification(telegramUserID int64, inquiry dto.ProductInquiry) error
